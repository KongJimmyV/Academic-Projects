...
main = do
    print "TESTING SETS"
    print (setIsMember (predicateToSet (\x -> x == "coke")) "coke")
    print (setIsMember (predicateToSet (\x -> x == "coke")) "pepsi")
    print (setIsMember (setComplement (predicateToSet(\ x -> x == "coke"))) "coke")
    print (setIsMember (setUnion (predicateToSet (\x -> x == "coke"))   (predicateToSet (\x -> x == "pepsi"))) "pepsi")
    print (setIsMember (setUnion (predicateToSet(\ x -> x == "coke"))  (predicateToSet(\ x -> x == "pepsi"))) "coke")
    print (setIsMember (setUnion (predicateToSet(\ x -> x == "coke"))   (predicateToSet(\ x -> x == "pepsi"))) "sprite")
    print (setIsMember (setIntersection (predicateToSet(\ x -> x == "coke"))   (predicateToSet(\ x -> x == "pepsi"))) "coke")
    print (setIsMember (setIntersection (predicateToSet(\ x -> x == "coke"))   (predicateToSet(\ x -> x == "coke"))) "coke")
    print (setIsMember (setIntersection (predicateToSet(\ x -> x == "coke"))   (predicateToSet(\ x -> x == "pepsi" || x == "coke"))) "coke")
    print (setIsMember (setComplement(predicateToSet(\x -> x > 0))) 5)
