...
main = do
    ...
    print (partition [1,2,3,4,5] 1)
    print (partition [1,2,3,4,5] (-12))
    print "count"
    print (count "b" ["a","b","c","c","b","b"])
    print (count 3 [])
    print (count 9 [1,3,4,1,3,4,4,3,1])
    print "removeAll"
    print (removeAll "b" ["a","b","c","c","b","b"])
    print (removeAll 3 [])
    print (removeAll 9 [1,3,4,1,3,4,4,3,1])
    print "counts"
    print (counts ["a","b","c","c","b","b"])
    print (counts [])
    print (counts [1,3,4,1,3,4,4,3,1])