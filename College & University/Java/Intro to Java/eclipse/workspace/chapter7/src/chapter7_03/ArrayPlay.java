	...
	public static void main(String[] args) {
		...
		for (int row = 0; row < mDArray.length; row++) {
			for (int col = 0; col < mDArray[row].length; col++) {
				...
				// If were on the first row, setup the initial population.
				if (row == 0) {
				...
				// If were not on the first row, do arithmetic for the roach population.
				else {
...
// ********************** METHODS **********************
	...
	private static void print2DArray(int[][] arr) {
		...
		// Print "|__|" decorations on the left side. 
		//
		//	Example:	|__|	Week	|Pop: 1
		//				|__|	0
		//				|__|	1
		//				etc...
		//
