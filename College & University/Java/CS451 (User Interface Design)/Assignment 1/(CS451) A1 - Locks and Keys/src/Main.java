...
public class Main {
    ...
    protected int lockCounter = 1001; // all lock IDs >= 1001
    protected int keyCounter = 1; // all key IDs are between 1 and 1000.
     ...
     * @throws java.lang.Exception when the room is not found.
     */
     ...
     * @throws java.lang.Exception when one of the entries is not found, 
