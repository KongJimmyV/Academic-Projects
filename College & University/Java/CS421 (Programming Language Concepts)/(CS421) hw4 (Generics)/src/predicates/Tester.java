...
public class Tester {
	...
	public static void mostAcceptsMostOf() {
        List<String> data = Arrays.asList( "abc", "", "a",  "a", "asfabcsdfasdf" );
        MostAcceptsMostOf<String> predicate = new MostAcceptsMostOf<String>(data);
        
        List<Collection<Predicate<String>>> tests = 
                Arrays.asList(
                    Arrays.asList(
                            new StartsWith<String>("a"),
                            new GreaterThan<String>(""),
                            new Negation<String>( new StartsWith<String>("z") ) 
                    ),
                    Arrays.asList(
                            new StartsWith<String>("a"),
                            new Negation<String>( new StartsWith<String>("z") ) 
                    ...
                    Arrays.asList(
                            new StartsWith<String>("z"),
                            new Negation<String>( new StartsWith<String>("a") ) 
                    ),
                    Arrays.asList(
                            new StartsWith<String>("c"),
                            new GreaterThan<String>("zzzzzzzzzzzzzzzzzzzzzzz"),
                            new Negation<String>( new StartsWith<String>("c") ) 
                    ),
                    Arrays.asList(
                            new StartsWith<String>("d"),
                            new GreaterThan<String>("zzzzzzzzzzzzzzzzzzzzzzz"),
                            new Negation<String>( new StartsWith<String>("d") ) 
                    ),
                    Arrays.asList(
                            new StartsWith<String>("e"),
                            new GreaterThan<String>("zzzzzzzzzzzzzzzzzzzzzzz"),
                            new Negation<String>( new StartsWith<String>("e") ) 
                    )
                );

        List<Boolean> oracle = Arrays.asList( true, true, false, false, false, false );     
        test( "MostAcceptsMostOf<String>", predicate, tests, oracle );      
    }
