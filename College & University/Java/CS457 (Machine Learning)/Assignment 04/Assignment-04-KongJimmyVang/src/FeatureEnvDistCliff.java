 ...
 * File Name:       FeatureEnvDistCliff.java    <br>
 * Description:     Feature class for feature-based learning.       <br><br>
 *                      s = state                                   <br>
 *                      a = action                                  <br>
 *                      s1 = state prime 1                          <br><br>
 *                      
 *                      f(s) = (L1 distance from s to nearest cliff) / (xMax + yMax)    <br>
 *                      f(s, a) = f(s1)                                                 <br><br>
 *                      
 ...
 */
public class FeatureEnvDistCliff extends FeatureEnv 
{
    //=== FIELDS ===
    private List<EnvCell2D> cliffs;
    private int xMax;
    private int yMax;
    
    //=== CONSTRUCTORS ===
    public FeatureEnvDistCliff(final Environment2D environment) {
        super(environment);
        setFeatureName("  dist-C");
        this.cliffs = environment.cliffs;
