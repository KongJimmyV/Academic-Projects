 ...
 * File Name:       FeatureEnvDistBlock.java    <br>
 * Description:     Feature class for feature-based learning.       <br><br>
 *                      s = state                                   <br>
 *                      a = action                                  <br>
 *                      s1 = state prime 1                          <br><br>
 *                      
 *                      f(s) = (L1 distance from s to nearest block) / (xMax + yMax)    <br>
 *                      f(s, a) = f(s1)                                                 <br><br>
 *                      
 ...
 */
public class FeatureEnvDistBlock extends FeatureEnv 
{
    //=== FIELDS ===
    private List<EnvCell2D> blocks;
    private int xMax;
    private int yMax;
    
    //=== CONSTRUCTORS ===
    public FeatureEnvDistBlock(final Environment2D environment) {
        super(environment);
        setFeatureName("  dist-B");
