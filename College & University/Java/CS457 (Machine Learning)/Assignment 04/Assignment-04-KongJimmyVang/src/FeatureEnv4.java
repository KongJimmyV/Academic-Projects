 ...
 */
public class FeatureEnv4 extends FeatureEnv 
{
    //=== FIELDS ===
    // see "FeatureEnv.java" for more information.
    
    //=== CONSTRUCTORS ===
    public FeatureEnv4(final Environment2D environment) {
        super(environment);
        setFeatureName("   ind-C");
    }
