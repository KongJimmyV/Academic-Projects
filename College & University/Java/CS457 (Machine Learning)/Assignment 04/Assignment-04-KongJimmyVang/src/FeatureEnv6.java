 ...
 * File Name:       FeatureEnv6.java    <br>
 * Description:     Feature class for feature-based learning.       <br><br>
 *                      s = state                                   <br>
 *                      a = action                                  <br>
 *                      s1 = state prime 1                          <br><br>
 *                      
 *                      f(s) = (L1 distance from s to nearest goal) / (xMax + yMax)     <br>
 *                      f(s, a) = f(s1)                                                 <br><br>
 *                      
 ...
 */
public class FeatureEnv6 extends FeatureEnv 
{
    //=== FIELDS ===
    private List<EnvCell2D> goalStates;
    private int xMax;
    private int yMax;
    
    //=== CONSTRUCTORS ===
    public FeatureEnv6(final Environment2D environment) {
        super(environment);
        setFeatureName("  dist-G");
        this.goalStates = environment.getGoalCells();
    ...
    public double f(final EnvCell2D state) 
    {
        ...
        //System.out.println(distanceToNearest / (xMax + yMax));
