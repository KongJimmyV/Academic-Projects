...
Begin VB.Form frmBattleship 
   ...
   Begin VB.Timer tmrAnimatedDeath 
      Enabled         =   0   'False
      Interval        =   50
      Left            =   8880
      Top             =   7200
   ...
   Begin VB.CommandButton cmd1 
      ...
      Index           =   1
      Left            =   9360
      Picture         =   "frmBattleship.frx":0442
      Style           =   1  'Graphical
      TabIndex        =   47
      Top             =   6240
      Width           =   1215
   ...
   Begin VB.CommandButton cmd2 
      ...
      Index           =   1
      Left            =   9360
      Picture         =   "frmBattleship.frx":460A2
      Style           =   1  'Graphical
      TabIndex        =   49
      Top             =   5880
      Width           =   1215
   ...
   Begin VB.CommandButton cmd1 
      ...
      Index           =   0
      Left            =   2760
      Picture         =   "frmBattleship.frx":8BD02
      Style           =   1  'Graphical
      TabIndex        =   46
      Top             =   6240
      Width           =   1215
   ...
   Begin VB.CommandButton cmd2 
      ...
      Index           =   0
      Left            =   2760
      Picture         =   "frmBattleship.frx":D1962
      Style           =   1  'Graphical
      TabIndex        =   48
      Top             =   5880
      Width           =   1215
   ...
   Begin VB.CommandButton cmdAutoAIplace 
      ...
      Index           =   0
      Left            =   2760
      Picture         =   "frmBattleship.frx":1175C2
      Style           =   1  'Graphical
      TabIndex        =   50
      Top             =   5520
      Width           =   1215
   ...
   Begin VB.Frame fraMenu 
      ...
      Begin VB.Frame fraAI 
         ...
         Begin VB.CommandButton cmdNewGame 
            ...
            Width           =   855
         End
         Begin VB.OptionButton optAI9999 
            BackColor       =   &H00404000&
            Caption         =   "Pattern-Op"
            ForeColor       =   &H00FFFFFF&
            Height          =   255
         ...
         Begin VB.ListBox lstMoves 
            Height          =   2595
            ItemData        =   "frmBattleship.frx":15D222
            Left            =   1440
            List            =   "frmBattleship.frx":15D229
            TabIndex        =   52
            Top             =   480
            Width           =   2415
         End
         Begin VB.OptionButton optAI0 
            BackColor       =   &H00FFC0C0&
            Caption         =   "PvP"
            Height          =   615
            Left            =   120
   ...
   Begin VB.Label Label1 
      BorderStyle     =   1  'Fixed Single
      Caption         =   "Gamemode:  Turn-Based Shots"
      BeginProperty Font 
         Name            =   "Garamond"
         Size            =   9
         Charset         =   0
   ...
   Begin VB.Label lbl2 
      BackColor       =   &H00000000&
      BorderStyle     =   1  'Fixed Single
      Caption         =   "Click a 'ship' and place it."
      BeginProperty Font 
   ...
   Begin VB.Image imgWater 
      ...
      Index           =   0
      Left            =   960
      MouseIcon       =   "frmBattleship.frx":15D237
      Stretch         =   -1  'True
      Top             =   1200
      Width           =   375
   End
    ...
    If Index = 0 Then
        ...
        If ShipsLeft <= 0 And ShipsLeft <> -1 And (TurnPlayer = True) Then
            s = 0
                ...
                If (AIDifficulty >= 1 And AIDifficulty <= 7) Or AIDifficulty = 9999 Then tmrAIPlacement.Enabled = True
...
Screen.MousePointer = vbHourglass
    ...
    lbl2.Caption = "Click a 'ship' and place it."
...
D:
    ...
    If Gamemode = GMhitSHOT Then
        'Do Nothing and Allow to keep firing
    End If
    
    If Gamemode = GMmultiSHOT Then
        If NumOfShotsLeft(t) <= 0 Then
            'Next Player's Turn
            'change label
            lbl1.Caption = "Player 1's Turn"
            'lbl2.Caption = "Battle!"
            ...
            TurnAI = False
            tmrAIAttack.Enabled = False
        ElseIf NumOfShotsLeft(t) > 0 Then
            'Do Nothing and Subtract Variable
            NumOfShotsLeft(t) = NumOfShotsLeft(t) - 1
        End If
    End If
    
    If Gamemode = GMshipmultiSHOT Then
        If NumOfShotsLeft(t) <= 0 Then
            'Next Player's Turn
            'change label
            lbl1.Caption = "Player 1's Turn"
...
C:
        ...
        RowTemp = Row
        ITemp = I
        Select Case Grid2(Row, Col)
            Case 0 To 6
            Call CheckShips
            'show move
            Rank = Row
            File = Col
            lstMoves.AddItem MoveNum(1) + 1 & ": 'P2' :: " & RankFile(Rank, File) & " :: : " & IndexStat(I) & vbCrLf
            strMove(f2, t) = MoveNum(1) + 1 & ": 'P2' :: " & RankFile(Rank, File) & " :: : " & IndexStat(I) & vbCrLf
            intMove(f2, t) = I
            f2 = f2 + 1
        End Select
        'Check Other
        ...
        If TurnAI = False Then tmrAIAttack.Enabled = False
        End If
    End If
...
C:
        ...
        Select Case Grid(Row, Col)
            ...
            Rank = Row
            File = Col
            lstMoves.AddItem MoveNum(2) + 1 & ": 'P1' :: " & RankFile(Rank, File) & " :: : " & IndexStat2(I) & vbCrLf
            'strMove(f1, t) = MoveNum(2) + 1 & ": 'P1' :: " & RankFile(Rank, File) & " :: : " & IndexStat2(I) & vbCrLf
            'intMove(f1, t) = I
            f1 = f1 + 1
            'Print strMove(f1, t)
        End Select
        ...
        Call CheckForVictory
        End If
        If TurnAI = True Then tmrAIAttack.Enabled = True
    End If
...
Private Sub lstMoves_MouseUp(Button As Integer, Shift As Integer, X As Single, Y As Single)

On Error Resume Next
    For t = 0 To 750
    Print lstMoves.ListIndex
    Select Case lstMoves
        Case strMove(t, 0)
            If shpCoordinates.Visible = False Then shpCoordinates.Visible = True
            Print "lstMoves":
            Print t:
            ...
            f = intMove(t, 0)
            shpCoordinates.Width = imgWater(f).Width
            shpCoordinates.Height = imgWater(f).Height
            
            shpCoordinates.Left = imgWater(f).Left
            shpCoordinates.Top = imgWater(f).Top
                Exit Sub
        ...
        Case strMove(t, 1)
            ...
            f = intMove(t, 1)
            shpCoordinates.Width = imgWater2(f).Width
            shpCoordinates.Height = imgWater2(f).Height
            
            shpCoordinates.Left = imgWater2(f).Left
            shpCoordinates.Top = imgWater2(f).Top
                Exit Sub
...
Private Sub tmr1_Timer()
    ...
    If AIDifficulty = 0 Then Call optAI0_Click
    If AIDifficulty = 1 Then Call optAI1_Click
    If AIDifficulty = 2 Then Call optAI2_Click
    If AIDifficulty = 3 Then Call optAI3_Click
    If AIDifficulty = 4 Then Call optAI4_Click
    ...
    If AIDifficulty = 6 Then Call optAI6_Click
    If AIDifficulty = 7 Then Call optAI7_Click
    If AIDifficulty = 9999 Then Call optAI9999_Click
    
    Select Case Gamemode
        Case 0
            Gamemode = 0
            Label1.Caption = "Gamemode:  " & "Turn-Based Shots"
        Case 1
            Gamemode = 1
            Label1.Caption = "Gamemode:  " & "Hit-Based Shots"
        Case 2
            Gamemode = 2
            Label1.Caption = "Gamemode:  " & "Multiple Shots"
        Case 3
            Gamemode = 3
            Label1.Caption = "Gamemode:  " & "Ships-Based Shots"
        Case 4
            Gamemode = 4
            Label1.Caption = "Gamemode:  " & "Memory-Based Shooting"
        Case Else
            Gamemode = -1
            Label1.Caption = "Gamemode:  " & "N/A"
    End Select
    tmr1.Enabled = False
    
End Sub

Private Sub tmrAnimatedDeath_Timer()

    GameOn = False      'Pause game for death
...
Private Sub mnuCheckShipDeath_Click()
    ...
    Print "AIPlacement: "
    Print tmrAIPlacement.Enabled:
    Print "AIAttack: "
    Print tmrAIAttack.Enabled:
...
Private Sub AIEvaluationVeryEasy()
    ...
    Call imgWater_MouseUp(I, 1, 0, imgWater(I).Left, imgWater(I).Top)
...
Else
    ...
    Rt = 10 - (ITemp2 \ 10 + 1)
        ...
        If DeadPatrolBoat(s) = False Then Max1 = Rt + 1: Min1 = Rt - 1
        If DeadDestroyer(s) = False Then Max1 = Rt + 2: Min1 = Rt - 2
        If DeadSubmarine(s) = False Then Max1 = Rt + 2: Min1 = Rt - 2
        If DeadBattleship(s) = False Then Max1 = Rt + 3: Min1 = Rt - 3
        If DeadCarrier(s) = False Then Max1 = Rt + 4: Min1 = Rt - 4
        
        If DeadPatrolBoat(s) = False Then Max2 = Ct + 1: Min2 = Ct - 1
        If DeadDestroyer(s) = False Then Max2 = Ct + 2: Min2 = Ct - 2
        If DeadSubmarine(s) = False Then Max2 = Ct + 2: Min2 = Ct - 2
        If DeadBattleship(s) = False Then Max2 = Ct + 3: Min2 = Ct - 3
        If DeadCarrier(s) = False Then Max2 = Ct + 4: Min2 = Ct - 4
...
End If
    ...
    For R = 0 To 9
        For C = 0 To 9
            ...
            If HitFound = False Then
            If Grid(R + 0, C + 0) = 7 Then AIMap(R + 1, C + 0) = AIMap(R + 1, C + 0) - 0
            If Grid(R - 0, C + 0) = 7 Then AIMap(R - 1, C + 0) = AIMap(R - 1, C + 0) - 0
            If Grid(R + 0, C + 0) = 7 Then AIMap(R + 0, C + 1) = AIMap(R + 0, C + 1) - 0
            If Grid(R + 0, C - 0) = 7 Then AIMap(R + 0, C - 1) = AIMap(R + 0, C - 1) - 0
            End If
        ...
        For C = Min1 To Max1
            ...
            'HCarrier
                If DeadCarrier(s) = False Then
                    ...
                    And (Grid(R + 0, C + 4) <> -1 And Grid(R + 0, C + 4) <> -2) _
                    And (C + 4 <= Max1) Then
                        AIMap(R + 0, C + 0) = AIMap(R + 0, C + 0) + 7
                        AIMap(R + 0, C + 1) = AIMap(R + 0, C + 1) + 11
                        AIMap(R + 0, C + 2) = AIMap(R + 2, C + 0) + 13
                        AIMap(R + 0, C + 3) = AIMap(R + 0, C + 3) + 11
                        AIMap(R + 0, C + 4) = AIMap(R + 0, C + 4) + 7
                    End If
                End If
            'VCarrier
                If DeadCarrier(s) = False Then
                    ...
                    And (R + 4 <= Max1) Then
                        AIMap(R + 0, C + 0) = AIMap(R + 0, C + 0) + 7
                        AIMap(R + 1, C + 0) = AIMap(R + 1, C + 0) + 11
                        AIMap(R + 2, C + 0) = AIMap(R + 2, C + 0) + 13
                        AIMap(R + 3, C + 0) = AIMap(R + 3, C + 0) + 11
                        AIMap(R + 4, C + 0) = AIMap(R + 4, C + 0) + 7
                    End If
                End If
            End If
            ...
            'HBattleship
                If DeadBattleship(s) = False Then
                    ...
                    And (Grid(R + 0, C + 3) <> -1 And Grid(R + 0, C + 3) <> -2) _
                    And (C + 3 <= Max1) Then
                        AIMap(R + 0, C + 0) = AIMap(R + 0, C + 0) + 6
                        AIMap(R + 0, C + 1) = AIMap(R + 0, C + 1) + 11
                        AIMap(R + 0, C + 2) = AIMap(R + 0, C + 2) + 11
                        AIMap(R + 0, C + 3) = AIMap(R + 0, C + 3) + 6
                    End If
                End If
            'VBattleship
                If DeadBattleship(s) = False Then
                    ...
                    And (R + 3 <= Max1) Then
                        AIMap(R + 0, C + 0) = AIMap(R + 0, C + 0) + 6
                        AIMap(R + 1, C + 0) = AIMap(R + 1, C + 0) + 11
                        AIMap(R + 2, C + 0) = AIMap(R + 2, C + 0) + 11
                        AIMap(R + 3, C + 0) = AIMap(R + 3, C + 0) + 6
                    End If
                End If
            End If
...
Private Sub AIAttack()
    ...
    If PlaceShips = False And GameOn = True Then
        ...
        If AIDifficulty = 0 Then tmrAIAttack.Enabled = False
        ...
        If AIDifficulty = 9999 Then Call AIEvaluation9999
        End If
    End If
...
Private Sub optAI0_Click()
optAI0.Value = True
    If optAI0.Value = True Then
        lblP2Area.Caption = "P2 " & "(" & optAI0.Caption & ")"
        lblP2Area.Caption = "P2 "
...
optAI1.Value = True
    If optAI1.Value = True Then
        ...
        optAI9999.Value = False
    End If
    If GameOn = True Then tmrAIAttack.Enabled = True Else tmrAIAttack.Enabled = False
...
Private Sub optAI9999_Click()
optAI9999.Value = True
    If optAI9999.Value = True Then
        lblP2Area.Caption = "P2 " & "(" & optAI9999.Caption & ")"
...
Screen.MousePointer = vbHourglass
    'tmrAIAttack.Enabled = False
    tmrAIAttack.Interval = Int(1 + (Rnd * 1))
    Call AIAttack
    'Call mnuGrid_Click
Screen.MousePointer = vbDefault
                ...
                For n = 0 To 99
                    ...
                    l = ((-1 * (R * XDefinition)) + (XDefinition * YDefinition)) + ((C * 1) - XDefinition)
                        If Grid2(R, C) = 6 And imgWater2(l).Tag = "Carrier" Then
                            Grid2(R, C) = -2
                            imgWater2(n).Picture = LoadPicture(App.Path & "\Images\FGSunk.gif")
                        End If
                Next n
                ...
                For n = 0 To 99
                    ...
                    l = ((-1 * (R * XDefinition)) + (XDefinition * YDefinition)) + ((C * 1) - XDefinition)
                        If Grid(R, C) = 6 And imgWater(l).Tag = "Battleship" Then
                            Grid(R, C) = -1
                            imgWater(n).Picture = LoadPicture(App.Path & "\Images\FGSunk.gif")
                        End If
                Next n
