...
Begin VB.Form frmMinesweeper 
   ...
   LinkTopic       =   "Form1"
   Picture         =   "frmMinesweeper.frx":0442
   ScaleHeight     =   10455
   ScaleWidth      =   11085
...
D:
        ...
        If IsBomb = True Then
            ...
            MsgBox "You Hit a Mine. " & Maze(R, C) & " Time: " & TotalTime(0) & " Seconds", vbCritical, "You Lost."
            GameOn = False
            MineHit = True
        End If
        ...
        If nCellsLeft <= 0 And IsBomb = False Then
            ...
            MsgBox "You sweeped the whole area without hitting a mine! " & Maze(R, C) & " Time: " & TotalTime(0) & " Seconds", vbExclamation, "You Won!"
            GameOn = False
        End If
...
'Reset Board
    ...
    For i = 0 To -1 + (XMaze * YMaze)
        With frmMinesweeper
            ...
            .imgCell(i).Left = IntFactor + .imgCell(0).Width * (i Mod YMaze)   ' * (i Mod YMaze + 1 - 1)
    ...
    With frmMinesweeper
        ...
        .lbl1Time.Left = IntFactor
        .lbl1Time.Top = .ScaleHeight - (.shpBox2.Height / 2) - .lbl1Time.Height / 2
        
        .lbl2Flags.Left = (.shpBox.Width) - .lbl2Flags.Width - IntFactor
...
'************revealLeft************
    ...
    For xcor = C To 0 Step -1
        ...
        If Maze(R, xcor) = 1 Then
            'Print "xcor" xcor
            Maze(R, xcor) = 0
            i = ((-1 * (R * YMaze)) + (XMaze * YMaze)) + ((xcor * 1) - XMaze)
    ...
    '>><<revealDown
        ...
        C2 = xcor
            ...
            If Maze(ycor, C2) = 1 Then
                'Print "ycor" ycor
                Maze(ycor, C2) = 0
                i = ((-1 * (ycor * YMaze)) + (XMaze * YMaze)) + ((C2 * 1) - XMaze)
                imgCell(i).Picture = LoadPicture(App.Path & "\Images\CellClicked.bmp")
                imgCell(i).Tag = "cEmpty"
                nCellsLeft = nCellsLeft - 1
            End If
            ...
            Or Maze(ycor, C2) = 5008 Or Maze(ycor, C2) = -5008) Then
                ...
                i = ((-1 * (ycor * YMaze)) + (XMaze * YMaze)) + ((C2 * 1) - XMaze)
                For zoneCount = 1 To 8
                    If zoneValue(ycor, C2) = zoneCount Then
                        frmMinesweeper.imgCell(i).Picture = LoadPicture(App.Path & "\Images\" & zoneCount & ".bmp")
                        If Maze(ycor, C2) = 5000 + zoneCount Then
                            nCellsLeft = nCellsLeft - 1
                        End If
    ...
    For xcor = C To -1 + XMaze Step 1
        ...
        Or Maze(R, xcor) = 5008 Or Maze(R, xcor) = -5008) Then
            ...
            For zoneCount = 1 To 8
                If zoneValue(R, xcor) = zoneCount Then
                    frmMinesweeper.imgCell(i).Picture = LoadPicture(App.Path & "\Images\" & zoneCount & ".bmp")
                    If Maze(R, xcor) = 5000 + zoneCount Then
                        nCellsLeft = nCellsLeft - 1
                    End If
                    zoneValue(R, xcor) = -zoneCount
                    Maze(R, xcor) = -zoneCount + -5000
...
'************revealDown************
    For ycor = R To 0 Step -1
        ...
        If Maze(ycor, C) = 1 Then
            'Print "ycor" ycor
            Maze(ycor, C) = 0
            i = ((-1 * (ycor * YMaze)) + (XMaze * YMaze)) + ((C * 1) - XMaze)
            imgCell(i).Picture = LoadPicture(App.Path & "\Images\CellClicked.bmp")
            imgCell(i).Tag = "cEmpty"
            nCellsLeft = nCellsLeft - 1
        End If
        ...
        Or Maze(ycor, C) = 5008 Or Maze(ycor, C) = -5008) Then
            ...
            i = ((-1 * (ycor * YMaze)) + (XMaze * YMaze)) + ((C * 1) - XMaze)
            For zoneCount = 1 To 8
                If zoneValue(ycor, C) = zoneCount Then
                    frmMinesweeper.imgCell(i).Picture = LoadPicture(App.Path & "\Images\" & zoneCount & ".bmp")
                    If Maze(ycor, C) = 5000 + zoneCount Then
                        nCellsLeft = nCellsLeft - 1
                    End If
    ...
    '>><<revealLeft
        ...
        R2 = ycor
            ...
            If Maze(R2, xcor) = 1 Then
                'Print "xcor" xcor
                Maze(R2, xcor) = 0
                i = ((-1 * (R2 * YMaze)) + (XMaze * YMaze)) + ((xcor * 1) - XMaze)
                imgCell(i).Picture = LoadPicture(App.Path & "\Images\CellClicked.bmp")
                imgCell(i).Tag = "cEmpty"
                nCellsLeft = nCellsLeft - 1
            End If
            ...
            Or Maze(R2, xcor) = 5008 Or Maze(R2, xcor) = -5008) Then
                ...
                i = ((-1 * (R2 * YMaze)) + (XMaze * YMaze)) + ((xcor * 1) - XMaze)
                For zoneCount = 1 To 8
                    If zoneValue(R2, xcor) = zoneCount Then
                        frmMinesweeper.imgCell(i).Picture = LoadPicture(App.Path & "\Images\" & zoneCount & ".bmp")
                        If Maze(R2, xcor) = 5000 + zoneCount Then
                            nCellsLeft = nCellsLeft - 1
                        End If
