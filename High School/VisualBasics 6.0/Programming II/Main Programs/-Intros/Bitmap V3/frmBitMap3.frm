...
Begin VB.Form frmBitMapIntro3 
   ...
   End
End
Attribute VB_Name = "frmBitMapIntro3"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim BitMap(1 To 30, 1 To 50) As Integer
Dim Map(1 To 30, 1 To 50) As Integer
...
Private Sub Form_Load()
    ...
    'set form size
    frmBitMapIntro3.Width = SFactor * 60
    frmBitMapIntro3.Height = SFactor * 40
    ...
    'open notepad file
    Open App.Path & "\Bitmap3.txt" For Input As #4
    ...
    Do While C < (30 * 50)
        ...
        Or MyChar = "3" _
        Or MyChar = "4" Then
            BitMap(C \ 50 + 1, C Mod 50 + 1) = Asc(MyChar) - 48
            'brick laying
            If MyChar = "1" Then
                shpBrick(BrickCount).Width = SFactor
                shpBrick(BrickCount).Height = SFactor
                shpBrick(BrickCount).Visible = True
                shpBrick(BrickCount).Left = SFactor * (C Mod 50 + 1 - 1)
                shpBrick(BrickCount).Top = SFactor * (C \ 50 + 1 - 1)
            ...
            If MyChar = "4" Then
                ...
                imgTarget1(TCount).Left = SFactor * (C Mod 50 + 1 - 1)
                imgTarget1(TCount).Top = SFactor * (C \ 50 + 1 - 1)
                TCount = TCount + 1
            End If
