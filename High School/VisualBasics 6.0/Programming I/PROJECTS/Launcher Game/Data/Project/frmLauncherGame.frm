...
Begin VB.Form frmLauncherGameVS 
   ...
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   Picture         =   "frmLauncherGame.frx":0000
   ScaleHeight     =   9495
   ScaleWidth      =   13605
   ...
   Begin VB.Image imgLauncher1Death 
      Height          =   1455
      Left            =   2520
      Picture         =   "frmLauncherGame.frx":138FEC
      Stretch         =   -1  'True
      Top             =   3000
      Width           =   1095
   End
   Begin VB.Image imgLauncher2Death 
      Height          =   1440
      Left            =   10080
      Picture         =   "frmLauncherGame.frx":141B50
      Stretch         =   -1  'True
      Top             =   3000
      Width           =   1170
   End
   Begin VB.Image imgLauncher1 
      Height          =   615
      Left            =   5000
      Picture         =   "frmLauncherGame.frx":14A6B4
      Stretch         =   -1  'True
      Top             =   360
      Width           =   615
   End
   Begin VB.Image imgLauncher2 
      Height          =   615
      Left            =   8000
      Picture         =   "frmLauncherGame.frx":14B896
      Stretch         =   -1  'True
      Top             =   8520
      Width           =   615
   End
   Begin VB.Image imgAmmoPlayer2 
      Height          =   495
      Left            =   8040
      Picture         =   "frmLauncherGame.frx":14C038
      Stretch         =   -1  'True
      Top             =   8040
      Width           =   495
   End
   Begin VB.Image imgAmmoPlayer1 
      Height          =   495
      Left            =   5040
      Picture         =   "frmLauncherGame.frx":14C7DA
      Stretch         =   -1  'True
      Top             =   960
      Width           =   495
   End
   ...
   End
End
Attribute VB_Name = "frmLauncherGameVS"
...
Private Sub Form_Load()
    ...
    'Dim file8() As Byte
    'file8 = LoadResData("102EXP", "CUSTOM")
    'Open "C:\" & "\Explosion - Fast Crackling Blast with Stereo Kick Back Explosion.mp3" For Binary As #8
    'Put #8, , file2
    'Close #8
    ...
    'Dim file9() As Byte
    'file9 = LoadResData("103LAS", "CUSTOM")
    'Open "C:\" & "\Laser - Quick Noise 2.mp3" For Binary As #9
    'Put #9, , file3
    'Close #9
...
If tmrGO.Enabled = True Then
    ...
    If ((imgAmmoPlayer1.Top > imgLauncher2.Top - 1500) And (imgAmmoPlayer1.Top < imgLauncher2.Top + 1500) And (imgAmmoPlayer1.Left > imgLauncher2.Left - 0) And (imgAmmoPlayer1.Left < imgLauncher2.Left + 2200)) And (imgLauncher2.Enabled = True) Then
        imgLauncher2.Left = imgLauncher2.Left - 100
    End If
    
    If ((imgAmmoPlayer1.Top > imgLauncher2.Top - 1500) And (imgAmmoPlayer1.Top < imgLauncher2.Top + 1500) And (imgAmmoPlayer1.Left > imgLauncher2.Left - 2200) And (imgAmmoPlayer1.Left < imgLauncher2.Left + 0)) And (imgLauncher2.Enabled = True) Then
        imgLauncher2.Left = imgLauncher2.Left + 100
    End If
    ...
    If imgLauncher1.Enabled = True And imgLauncher2.Enabled = True And tmrAmmoPlayer2.Enabled = False And imgLauncher2.Enabled = True Then
        If ((imgLauncher1.Left >= imgLauncher2.Left) And (imgLauncher1.Left <= imgLauncher2.Left + 2000)) Or ((imgLauncher1.Left <= imgLauncher2.Left) And (imgLauncher1.Left >= imgLauncher2.Left - 2000)) Then
            If wmpLaser.settings.mute = True Then
                wmpLaser.settings.mute = False
            End If
            imgAmmoPlayer2.Enabled = True
            imgAmmoPlayer2.Visible = True
            imgAmmoPlayer2.Left = imgLauncher2.Left + 50
            imgAmmoPlayer2.Top = imgLauncher2.Top + 200
            tmrAmmoPlayer2.Enabled = True
            wmpLaser.Controls.stop
            wmpLaser.Controls.play
        End If
    End If
    ...
    If imgLauncher2.Left < -100 And tmrAI.Enabled = True And imgLauncher2.Enabled = True Then
        imgLauncher2.Left = 13100
        Else
        If (imgLauncher1.Left <= imgLauncher2.Left And (imgAmmoPlayer1.Enabled = False Or imgAmmoPlayer1.Top > imgLauncher2.Top - 5500)) And imgLauncher1.Enabled = True And imgLauncher2.Enabled = True Then
            imgLauncher2.Left = imgLauncher2.Left - 100
            Else
        End If
    End If
...
Private Sub tmrDraw_Timer()
    ...
    If (imgLauncher1.Enabled = False And imgLauncher2.Enabled = False) And (imgAmmoPlayer1.Enabled = False And imgAmmoPlayer2.Enabled = False) And (frmLauncherGameVS.Enabled = True) Then
        MsgBox ("DRAW!!!")
        tmrDraw.Enabled = False
        frmLauncherGameVS.Visible = False
        frmLauncherGameVS.Enabled = False
...
Private Sub tmrWinner1_Timer()
    ...
    If imgLauncher1.Enabled = True And imgLauncher2.Enabled = False And (frmLauncherGameVS.Enabled = True) Then
...
Private Sub tmrWinner2_Timer()
    ...
    If imgLauncher2.Enabled = True And imgLauncher1.Enabled = False And (frmLauncherGameVS.Enabled = True) Then
