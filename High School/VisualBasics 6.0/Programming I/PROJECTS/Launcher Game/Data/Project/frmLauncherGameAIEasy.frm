...
Begin VB.Form frmLauncherGameAIEasy 
   ...
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   Picture         =   "frmLauncherGameAIEasy.frx":0000
   ScaleHeight     =   9495
   ScaleWidth      =   13605
   StartUpPosition =   1  'CenterOwner
   Visible         =   0   'False
   Begin VB.Timer tmrAIShoot 
      Interval        =   3000
      Left            =   4680
      Top             =   3240
   End
   ...
   Begin VB.Image imgLauncher1Death 
      Height          =   1455
      Left            =   2520
      Picture         =   "frmLauncherGameAIEasy.frx":5EEC42
      Stretch         =   -1  'True
      Top             =   3000
      Width           =   1095
   End
   Begin VB.Image imgLauncher2Death 
      Height          =   1440
      Left            =   10080
      Picture         =   "frmLauncherGameAIEasy.frx":5F77A6
      Stretch         =   -1  'True
      Top             =   3000
      Width           =   1170
   End
   Begin VB.Image imgLauncher1 
      Height          =   615
      Left            =   5000
      Picture         =   "frmLauncherGameAIEasy.frx":60030A
      Stretch         =   -1  'True
      Top             =   360
      Width           =   615
   End
   Begin VB.Image imgLauncher2 
      Height          =   615
      Left            =   8000
      Picture         =   "frmLauncherGameAIEasy.frx":6014EC
      Stretch         =   -1  'True
      Top             =   8520
      Width           =   615
   End
   Begin VB.Image imgAmmoPlayer2 
      Height          =   495
      Left            =   8040
      Picture         =   "frmLauncherGameAIEasy.frx":601C8E
      Stretch         =   -1  'True
      Top             =   8040
      Width           =   495
   End
   Begin VB.Image imgAmmoPlayer1 
      Height          =   495
      Left            =   5040
      Picture         =   "frmLauncherGameAIEasy.frx":602430
      Stretch         =   -1  'True
      Top             =   960
      Width           =   495
   End
   ...
   End
End
Attribute VB_Name = "frmLauncherGameAIEasy"
...
Private Sub Form_Load()
    ...
    'Dim file6() As Byte
    'file6 = LoadResData("102EXP", "CUSTOM")
    'Open "C:\" & "\Explosion - Fast Crackling Blast with Stereo Kick Back Explosion.mp3" For Binary As #6
    'Put #6, , file2
    'Close #6
    ...
    'Dim file7() As Byte
    'file7 = LoadResData("103LAS", "CUSTOM")
    'Open "C:\" & "\Laser - Quick Noise 2.mp3" For Binary As #7
    'Put #7, , file3
    'Close #7
...
If tmrGO.Enabled = True Then
    ...
    If ((tmrAIMovementTimedR = False) And (imgAmmoPlayer1.Top > imgLauncher2.Top - 1000) And (imgAmmoPlayer1.Top < imgLauncher2.Top + 1000) And (imgAmmoPlayer1.Left > imgLauncher2.Left - 0) And (imgAmmoPlayer1.Left < imgLauncher2.Left + 2200)) And (imgLauncher2.Enabled = True) Then
        imgLauncher2.Left = imgLauncher2.Left - 100
    End If
    
    If ((tmrAIMovementTimedL = False) And (imgAmmoPlayer1.Top > imgLauncher2.Top - 1000) And (imgAmmoPlayer1.Top < imgLauncher2.Top + 1000) And (imgAmmoPlayer1.Left > imgLauncher2.Left - 2200) And (imgAmmoPlayer1.Left < imgLauncher2.Left + 0)) And (imgLauncher2.Enabled = True) Then
        imgLauncher2.Left = imgLauncher2.Left + 100
    End If
    ...
    If imgLauncher2.Left < -100 And tmrAI.Enabled = True And imgLauncher2.Enabled = True Then
        imgLauncher2.Left = 13100
        Else
        If ((tmrAIMovementTimedR = True And (imgAmmoPlayer1.Enabled = False Or (imgAmmoPlayer1.Top < imgLauncher2.Top - 1000) And (imgAmmoPlayer1.Left >= imgLauncher2.Left - 2200 Or imgAmmoPlayer1.Left <= imgLauncher2.Left + 2200)))) And imgLauncher1.Enabled = True And imgLauncher2.Enabled = True Then
            imgLauncher2.Left = imgLauncher2.Left - 100
            Else
        End If
    End If
    ...
    If imgLauncher2.Left > 13100 And tmrAI.Enabled = True And imgLauncher2.Enabled = True Then
        imgLauncher2.Left = -100
        Else
        If (tmrAIMovementTimedL = True And (imgAmmoPlayer1.Enabled = False Or (imgAmmoPlayer1.Top < imgLauncher2.Top - 1000 And (imgAmmoPlayer1.Left <= imgLauncher2.Left + 2200 Or imgAmmoPlayer1.Left >= imgLauncher2.Left - 2200)))) And imgLauncher1.Enabled = True And imgLauncher2.Enabled = True Then
            imgLauncher2.Left = imgLauncher2.Left + 100
            Else
        End If
    End If
...
Private Sub tmrAIMovementTimedL_Timer()
    ...
    randomvalue = CInt(Int((upperbound - lowerbound + 4000) * Rnd() + lowerbound))
...
Private Sub tmrDraw_Timer()
    ...
    If (imgLauncher1.Enabled = False And imgLauncher2.Enabled = False) And (imgAmmoPlayer1.Enabled = False And imgAmmoPlayer2.Enabled = False) And (frmLauncherGameAIEasy.Enabled = True) Then
        MsgBox ("DRAW!!!")
        tmrDraw.Enabled = False
        frmLauncherGameAIEasy.Visible = False
        frmLauncherGameAIEasy.Enabled = False
...
Private Sub tmrAIShoot_Timer()

    upperbound = 5000
    lowerbound = 200
    randomShoot = CInt(Int((upperbound - lowerbound + 4000) * Rnd() + lowerbound))
    ...
    tmrAIShoot.Interval = randomShoot
    
End Sub

Private Sub tmrWinner1_Timer()

    If imgLauncher1.Enabled = True And imgLauncher2.Enabled = False And (frmLauncherGameAIEasy.Enabled = True) Then
...
Private Sub tmrWinner2_Timer()
    ...
    If imgLauncher2.Enabled = True And imgLauncher1.Enabled = False And (frmLauncherGameAIEasy.Enabled = True) Then
