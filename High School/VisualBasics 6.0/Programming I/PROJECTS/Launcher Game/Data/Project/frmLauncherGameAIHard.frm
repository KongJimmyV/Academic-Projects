...
Begin VB.Form frmLauncherGameAIHard 
   ...
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   Picture         =   "frmLauncherGameAIHard.frx":0000
   ScaleHeight     =   9495
   ScaleWidth      =   13605
   ...
   Begin VB.Image imgLauncher1Death 
      Height          =   1455
      Left            =   2520
      Picture         =   "frmLauncherGameAIHard.frx":138FEC
      Stretch         =   -1  'True
      Top             =   3000
      Width           =   1095
   End
   Begin VB.Image imgLauncher2Death 
      Height          =   1440
      Left            =   10080
      Picture         =   "frmLauncherGameAIHard.frx":141B50
      Stretch         =   -1  'True
      Top             =   3000
      Width           =   1170
   End
   Begin VB.Image imgLauncher1 
      Height          =   615
      Left            =   5000
      Picture         =   "frmLauncherGameAIHard.frx":14A6B4
      Stretch         =   -1  'True
      Top             =   360
      Width           =   615
   End
   Begin VB.Image imgLauncher2 
      Height          =   615
      Left            =   8000
      Picture         =   "frmLauncherGameAIHard.frx":14B896
      Stretch         =   -1  'True
      Top             =   8520
      Width           =   615
   End
   Begin VB.Image imgAmmoPlayer2 
      Height          =   495
      Left            =   8040
      Picture         =   "frmLauncherGameAIHard.frx":14C038
      Stretch         =   -1  'True
      Top             =   8040
      Width           =   495
   End
   Begin VB.Image imgAmmoPlayer1 
      Height          =   495
      Left            =   5040
      Picture         =   "frmLauncherGameAIHard.frx":14C7DA
      Stretch         =   -1  'True
      Top             =   960
      Width           =   495
   End
   ...
   End
End
Attribute VB_Name = "frmLauncherGameAIHard"
...
Private Sub tmrAIMovementTimedL_Timer()
    ...
    'AI Movement
    If imgLauncher1.Left <= imgLauncher2.Left - 1060 And imgLauncher1.Left <= imgLauncher2.Left Then
        upperbound = 100
        lowerbound = 5
        randomvalue = CInt(Int((upperbound - lowerbound + 100) * Rnd() + lowerbound))
