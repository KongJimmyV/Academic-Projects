...
Begin VB.Form frmLauncherGameAIFight 
   ...
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   Picture         =   "frmLauncherGameAIHard2.frx":0000
   ScaleHeight     =   9495
   ScaleWidth      =   13605
   StartUpPosition =   1  'CenterOwner
   Visible         =   0   'False
   Begin VB.Timer tmrAIMovementTimedR2 
      Enabled         =   0   'False
      Interval        =   1000
      Left            =   5040
      Top             =   4080
   End
   Begin VB.Timer tmrAIMovementTimedL2 
      Interval        =   1000
      Left            =   4680
      Top             =   4080
   End
   ...
   Begin VB.Image imgLauncher1Death 
      Height          =   1455
      Left            =   2520
      Picture         =   "frmLauncherGameAIHard2.frx":138FEC
      Stretch         =   -1  'True
      Top             =   3000
      Width           =   1095
   End
   Begin VB.Image imgLauncher2Death 
      Height          =   1440
      Left            =   10080
      Picture         =   "frmLauncherGameAIHard2.frx":141B50
      Stretch         =   -1  'True
      Top             =   3000
      Width           =   1170
   End
   Begin VB.Image imgLauncher1 
      Height          =   615
      Left            =   5000
      Picture         =   "frmLauncherGameAIHard2.frx":14A6B4
      Stretch         =   -1  'True
      Top             =   360
      Width           =   615
   End
   Begin VB.Image imgLauncher2 
      Height          =   615
      Left            =   8000
      Picture         =   "frmLauncherGameAIHard2.frx":14B896
      Stretch         =   -1  'True
      Top             =   8520
      Width           =   615
   End
   Begin VB.Image imgAmmoPlayer2 
      Height          =   495
      Left            =   8040
      Picture         =   "frmLauncherGameAIHard2.frx":14C038
      Stretch         =   -1  'True
      Top             =   8040
      Width           =   495
   End
   Begin VB.Image imgAmmoPlayer1 
      Height          =   495
      Left            =   5040
      Picture         =   "frmLauncherGameAIHard2.frx":14C7DA
      Stretch         =   -1  'True
      Top             =   960
      Width           =   495
   End
   ...
   End
End
Attribute VB_Name = "frmLauncherGameAIFight"
...
If tmrGO.Enabled = True Then
    If KeyCode = vbKeyRight And imgLauncher1.Enabled = True And tmrAI2.Enabled = False Then
        tmrPlayer1R.Enabled = True
        End If

    If KeyCode = vbKeyLeft And imgLauncher1.Enabled = True And tmrAI2.Enabled = False Then
        tmrPlayer1L.Enabled = True
        End If

    If KeyCode = vbKeyUp And tmrAmmoPlayer1.Enabled = False And imgLauncher1.Enabled = True And tmrAI2.Enabled = False Then
...
Private Sub Form_Load()
    ...
    'Dim file2() As Byte
    'file2 = LoadResData("102EXP", "CUSTOM")
    'Open "C:\" & "\Explosion - Fast Crackling Blast with Stereo Kick Back Explosion.mp3" For Binary As #2
    'Put #2, , file2
    'Close #2
    ...
    'Dim file3() As Byte
    'file3 = LoadResData("103LAS", "CUSTOM")
    'Open "C:\" & "\Laser - Quick Noise 2.mp3" For Binary As #3
    'Put #3, , file3
    'Close #3
...
Private Sub tmrAI_Timer()
    ...
    upperbound = 3000
    lowerbound = 900
    randomvalue = CInt(Int((upperbound - lowerbound + 100) * Rnd() + lowerbound))
...
If tmrGO.Enabled = True Then
    ...
    If ((imgAmmoPlayer1.Top > imgLauncher2.Top - randomvalue) And (imgAmmoPlayer1.Top < imgLauncher2.Top + 1380) And (imgAmmoPlayer1.Left > imgLauncher2.Left - 0) And (imgAmmoPlayer1.Left < imgLauncher2.Left + 2200)) And (imgLauncher2.Enabled = True) Then
        imgLauncher2.Left = imgLauncher2.Left - 100
    End If
    
    If ((imgAmmoPlayer1.Top > imgLauncher2.Top - randomvalue) And (imgAmmoPlayer1.Top < imgLauncher2.Top + 1380) And (imgAmmoPlayer1.Left > imgLauncher2.Left - 2200) And (imgAmmoPlayer1.Left < imgLauncher2.Left + 0)) And (imgLauncher2.Enabled = True) Then
        imgLauncher2.Left = imgLauncher2.Left + 100
    End If
    ...
    If imgLauncher1.Enabled = True And imgLauncher2.Enabled = True And tmrAmmoPlayer2.Enabled = False And imgLauncher2.Enabled = True Then
        If ((imgLauncher1.Left >= imgLauncher2.Left) And (imgLauncher1.Left <= imgLauncher2.Left + 100000)) Or ((imgLauncher1.Left <= imgLauncher2.Left) And (imgLauncher1.Left >= (imgLauncher2.Left - 100000))) Then
            If wmpLaser2.settings.mute = True Then
                wmpLaser2.settings.mute = False
            End If
            
            'Smart AI Distance Close Firing
            If (imgLauncher1.Left >= imgLauncher2.Left - 350 And imgLauncher1.Left <= imgLauncher2.Left + 350) And (tmrPlayer1L.Enabled = False And tmrPlayer1R.Enabled = False) And (imgAmmoPlayer2.Enabled = False) Then
                imgAmmoPlayer2.Enabled = True
                imgAmmoPlayer2.Visible = True
                imgAmmoPlayer2.Left = imgLauncher2.Left + 50
                imgAmmoPlayer2.Top = imgLauncher2.Top + 200
            ...
            'Smart AI Distance Ranged Aiming
            If (tmrPlayer1L.Enabled = True Or tmrPlayer1R.Enabled = True) And (imgAmmoPlayer2.Enabled = False) And (((imgLauncher1.Left >= imgLauncher2.Left) And (imgLauncher1.Left <= imgLauncher2.Left + 2500)) Or ((imgLauncher1.Left <= imgLauncher2.Left) And imgLauncher1.Left >= (imgLauncher2.Left - 2500))) Then
                'Check Launcher1 to be Aligned with Ammo shot
                If imgLauncher1.Left = imgLauncher2.Left Or (imgLauncher1.Left + imgLauncher1.Left >= imgLauncher2.Left Or imgLauncher1.Left + imgLauncher1.Left <= imgLauncher2.Left) Then
                    imgAmmoPlayer2.Enabled = True
                    imgAmmoPlayer2.Visible = True
                    imgAmmoPlayer2.Left = imgLauncher2.Left + 50
                    imgAmmoPlayer2.Top = imgLauncher2.Top + 200
    ...
    'AI Movement Based on Player
    
    If imgLauncher2.Left < -100 And tmrAI.Enabled = True And imgLauncher2.Enabled = True Then
        imgLauncher2.Left = 13100
        Else
        If (((imgLauncher1.Left <= imgLauncher2.Left - 1060 Or tmrAIMovementTimedR = True)) And (imgAmmoPlayer1.Enabled = False Or (imgAmmoPlayer1.Top < imgLauncher2.Top - randomvalue And (imgAmmoPlayer1.Left >= imgLauncher2.Left - 2200 Or imgAmmoPlayer1.Left <= imgLauncher2.Left + 2200)))) And imgLauncher1.Enabled = True And imgLauncher2.Enabled = True Then
            imgLauncher2.Left = imgLauncher2.Left - 100
            Else
        End If
    End If
    ...
    If imgLauncher2.Left > 13100 And tmrAI.Enabled = True And imgLauncher2.Enabled = True Then
        imgLauncher2.Left = -100
        Else
        If (((imgLauncher1.Left >= imgLauncher2.Left + 1060 Or tmrAIMovementTimedL = True)) And (imgAmmoPlayer1.Enabled = False Or (imgAmmoPlayer1.Top < imgLauncher2.Top - randomvalue And (imgAmmoPlayer1.Left <= imgLauncher2.Left + 2200 Or imgAmmoPlayer1.Left >= imgLauncher2.Left - 2200)))) And imgLauncher1.Enabled = True And imgLauncher2.Enabled = True Then
            imgLauncher2.Left = imgLauncher2.Left + 100
            Else
        End If
    End If
...
If tmrGO.Enabled = True Then
    ...
    If imgLauncher1.Left > 13100 And imgLauncher2.Enabled = True And imgLauncher1.Enabled = True Then
        imgLauncher1.Left = -100
    End If
    
    If imgLauncher1.Left < -100 And imgLauncher2.Enabled = True And imgLauncher1.Enabled = True Then
...
Private Sub tmrAIMovementTimedL_Timer()
    ...
    'AI Movement
    If imgLauncher1.Left <= imgLauncher2.Left - 1060 And imgLauncher1.Left <= imgLauncher2.Left And tmrAI.Enabled = True Then
        upperbound = 100
        lowerbound = 5
        randomvalue = CInt(Int((upperbound - lowerbound + 100) * Rnd() + lowerbound))
...
Private Sub tmrDraw_Timer()
    ...
    If (imgLauncher1.Enabled = False And imgLauncher2.Enabled = False) And (imgAmmoPlayer1.Enabled = False And imgAmmoPlayer2.Enabled = False) And (frmLauncherGameAIHard.Enabled = True) Then
        MsgBox ("DRAW!!!")
        tmrDraw.Enabled = False
        frmLauncherGameAIHard.Visible = False
        frmLauncherGameAIHard.Enabled = False
...
Private Sub tmrWinner1_Timer()
    ...
    If imgLauncher1.Enabled = True And imgLauncher2.Enabled = False And (frmLauncherGameAIHard.Enabled = True) Then
...
Private Sub tmrWinner2_Timer()
    ...
    If imgLauncher2.Enabled = True And imgLauncher1.Enabled = False And (frmLauncherGameAIHard.Enabled = True) Then
